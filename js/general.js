...
jQuery(document).ready(function () {
  ...
  if (
    $(".input-styled, .shop-page .create-account, .shop-page .payment_methods")
      .length > 0
  ) {
    $(
      ".input-styled input, .create-account input, .payment_methods input"
    ).customInput();
  }
  ...
  function openAndCloseSubMenuItem() {
    $(".theme-menu .menu li.active-item")
      .addClass("open")
      .children("ul")
      .show();
    $(".theme-menu .menu li.menu-item-has-children > a.menu-icon").on(
      "click",
      function () {
  ...
  function shopProductsSlider() {
    ...
    $(".shop-page.shop-page-product-details .product").css(
      "height",
      sumTotalScreenHeight
    );
  }
  ...
  if ($(".shop-page-checkout").length > 0) {
    ...
    $(".create-account label[for='createaccount']").click(function () {
      $(this)
        .parents("form.checkout")
        .find(".create-account-form")
        .slideToggle("fast");
    });
  }
});
...
function addLink() {
  ...
  var pagelink =
    ...
    "'>" +
    document.location.href +
    "</a> CubeCreation &copy; All Right Reserved</p>";
